...
export const reservationsSlice = createSlice({
    ...
    reducers: {
        ...
        opacity: (state, action: PayloadAction<any>)=>{
               state.value[action.payload][5] = '0'
            }, 
    },
})

export const {addReservation, changeQuantity, deleteBook, opacity } = reservationsSlice.actions
