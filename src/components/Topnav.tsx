...
export default function Topnav() {
  ...
  const [menu, setMenu] = useState('250px')
  ...
  return (
    ...
    <div id="topBarLinks" className='text-black font-semibold' style={{left: menu}}>
      <a href="#" >NEW</a>
      <a href="#">BESTSELLERS</a>
      <a href="#">DISCOUNTS</a>
    <FontAwesomeIcon id='xMark' className='text-red-500 hover:text-red-400' icon={faSquareXmark} onClick={e=>setMenu('100%')} />
    </div>
    ...
    <FontAwesomeIcon id='hamburger' className='topBarIcons text-black hover:cursor-pointer text-3xl' icon={faBars} onClick={e=>{setMenu('0'); setSearch('-100px')}} />
    </div>
